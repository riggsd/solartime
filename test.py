...
class SolarTimeTest(unittest.TestCase):
    ...
    def test_sunrise(self):
        ...
        expected_sunrise = datetime(2015, 1, 20, 7, 29, tzinfo=self.localtz)
    ...
    def test_sunset(self):
        ...
        expected_sunset = datetime(2015, 1, 20, 17, 26, tzinfo=self.localtz)
    ...
    def test_solarnoon(self):
        ...
        expected_noon = datetime(2015, 1, 20, 12, 27, 00, tzinfo=self.localtz)
    ...
    def test_dawn(self):
        ...
        expected_dawn = datetime(2015, 1, 20, 7, 00, tzinfo=self.localtz)  # end of civil twilight
    ...
    def test_dusk(self):
        ...
        expected_dusk = datetime(2015, 1, 20, 17, 54, tzinfo=self.localtz)  # end of civil twilight
